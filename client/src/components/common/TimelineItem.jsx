const TimelineItem = ({ year, title, description, isLast }) => (
  <div className="flex gap-6">
    ...
    <div className="flex flex-col items-center ">
      <div className="w-4 h-4 rounded-full bg-gradient-to-r from-brand to-brand-dark shrink-0" />
    ...
    <div className="pb-8 flex-1">
      ...
      <h4 className="text-xl font-bold text-muted-foreground mb-2">{title}</h4>
